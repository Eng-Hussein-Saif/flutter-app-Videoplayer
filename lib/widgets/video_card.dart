...
//   @override
//   Widget build(BuildContext context) {
//     // تنسيق وقت النشر باللغة العربية
...
//                           Flexible(
//                             child: Text(
//                               '${video.author.username} • ${video.viewCount} مشاهدة •  $formattedTimestamp',
//                               maxLines: 3,
//                               overflow: TextOverflow.ellipsis,
//                               textAlign: TextAlign.right,
//                               style: Theme.of(context)
...
//         return GestureDetector(
//           onTap: () {
//             // تعيين الفيديو المحدد باستخدام Riverpod
//             ref.read(selectedVideoProvider.notifier).state = video as YoutubePlayerController?;
